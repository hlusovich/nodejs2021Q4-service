...
export class TasksController {
  ...
  async getAll(): Promise<TaskModel[]> {
    ...
    async create(@Body(new ValidationPipe()) taskDto: TaskDto, @Param('boardId') boardId: string): Promise<TaskModel | undefined> {
    ...
    async update(@Body(new ValidationPipe()) taskDto: TaskDto, @Param('id') id: string): Promise<TaskModel | undefined> {
      try {
