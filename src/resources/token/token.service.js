...
var TokenService = (function () {
    ...
    TokenService.saveToken = function (userId, newToken) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenData, result_1, createdTokenData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, tokens_1.TokensModel.findOne({ userId: userId })];
                    case 1:
                        tokenData = _a.sent();
                    ...
                    case 2:
                        result_1 = _a.sent();
                        return [2, result_1];
                    case 3: return [4, tokens_1.TokensModel.create({ userId: userId, token: newToken })];
                    case 4:
                        createdTokenData = _a.sent();
                        return [4, createdTokenData.save()];
                    case 5:
                        result = _a.sent();
                        return [2, result];
                }
