...
var BoardsController = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("boards");
                        return [4, boardContoller_1.BoardsModelController.getAll()];
                    case 1:
                        result = _a.sent();
                        return [2, result];
                }
    ...
    BoardsController.prototype.getOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, boardContoller_1.BoardsModelController.getBoardById(id)];
                    case 1:
                        result = _a.sent();
                        return [2, result];
                }
    ...
    BoardsController.prototype.create = function (boardDto) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, boardContoller_1.BoardsModelController.createBoard(boardDto)];
                    case 1:
                        result = _a.sent();
                        return [2, result];
                }
    ...
    BoardsController.prototype.update = function (boardDto, id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, boardContoller_1.BoardsModelController.updateBoard(id, boardDto)];
                    case 1:
                        result = _a.sent();
                        return [2, result];
                }
    ...
    BoardsController.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var deleteResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, boardContoller_1.BoardsModelController.deleteBoard(id)];
                    case 1:
