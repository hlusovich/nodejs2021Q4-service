...
const board_model_js_1 = require("./board.model.js");
const _404error_js_1 = require("../../../Errors/404error.js");

const BoardsController = (function () {
    ...
    BoardsController.prototype.createBoard = function (payload) {
        const board = new board_model_js_1.Board(payload);
    ...
    BoardsController.prototype.updateBoard = function (id, payload) {
        ...
        this.boards = this.boards.map((item) => {
            if (item.id === id) {
                return new board_model_js_1.Board({...item, ...payload});
            }
            return item;
        });
