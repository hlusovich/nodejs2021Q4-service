...
const TaskModelController = (function () {
    ...
    TaskModelController.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, (_a) => {
                switch (_a.label) {
                    case 0: return [4, task_js_1.TaskModel.query("SELECT * FROM tasks6")];
    ...
    TaskModelController.createTask = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, (_a) => {
                switch (_a.label) {
                    case 0: return [4, task_js_1.TaskModel.create({ ...data})];
                    case 1:
                        task = _a.sent();
                        return [4, task.save()];
                    case 2:
    ...
    TaskModelController.updateTask = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, (_a) => {
                switch (_a.label) {
                    case 0: return [4, task_js_1.TaskModel.update(id, { ...data})];
                    case 1: return [2, _a.sent()];
                }
            });
        });
