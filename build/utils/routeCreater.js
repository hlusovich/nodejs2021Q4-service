...
const setStatusCode_js_1 = require("./setStatusCode.js");
const errorHandler_js_1 = require("../handler/errorHandler.js");
const Logger_js_1 = require("./Logger.js");

const createRoute = function (method, path, handler) { return ({
    method,
    path,
    handler (req, h) {
        return __awaiter(this, void 0, void 0, function () {
            let query; let message; let response; let _a; let _b; let e_1; let moc;
            return __generator(this, (_c) => {
                switch (_c.label) {
                    ...
                    case 2:
                        response = _c.sent();
                        Logger_js_1.default.log({ level: 2, message });
...
// # sourceMappingURL=routeCreater.js.map